...
contract testSuite {
    ...
    function testNonOwnerPermissions() public {
        ...
        try trainsOracle.addStation("Venice") {
            success = true;
        } catch {
            success = false;
        }
        ...
        try trainsOracle.addConsecutiveSegment("CS002", "Train1", "Rome", "Florence", block.timestamp + 1 hours, 100) {
            success = true;
        } catch {
            success = false;
        }
        ...
        try trainsOracle.addDynamicConsecutiveSegment("DCS002", "CS001") {
            success = true;
        } catch {
            success = false;
        }
